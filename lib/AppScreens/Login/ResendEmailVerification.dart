...
class ResendEmailVerification extends StatefulWidget {
  ...
  @override
  _ResendEmailVerificationState createState() => _ResendEmailVerificationState();
}
...
class _ResendEmailVerificationState extends State<ResendEmailVerification> {
  ...
  void resendEmailVerificationLink() async{
      try {
        await _auth.sendPasswordResetEmail(_emailTextController.text);
        print("Email Verification Link resent Successfully");
        Toast.show("Email Verification Link Sent Successfully", context, duration: Toast.LENGTH_LONG, gravity: Toast.TOP);
        setState(() {
          isLoading = false;
        ...
        setState(() {
          print("Inside Resend Email Verification Link Catch: " + e.toString());
            ...
            children: <Widget>[
              Padding(
                ...
                child: Container(
                    width: 100,
                    height: 165,
                    child: ResendEmailVerification.logo
                ),
              ), //LOGO
              Padding(
